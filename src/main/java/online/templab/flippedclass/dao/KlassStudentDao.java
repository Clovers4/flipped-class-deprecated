...
public interface KlassStudentDao {
     ...
     * 更新一条记录。
     *
     * @param record 一条被修改，但未被持久化的班级-学生关系实体类
     * @return 更新的行数，只可能为0或1.
     */
    int updateById(KlassStudent record);

    /**
     * 查找一条记录。
     *
     * @param id
     * @return 一个班级-学生关系实体类，或者NULL
     */
    KlassStudent getById(Integer id);

    /**
     * 查询所有记录。
     *
     * @return 一个List，包含班级-学生关系表中的所有记录
     */
    List<KlassStudent> listAll();
